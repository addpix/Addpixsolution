...
{
    class PerformanceInvoiceData
    {
        DataTable source2, source1;
        public PerformanceInvoiceData()
        {
            //this.source = data;
        }
        public  PerformanceInvoiceData(DataTable data, DataTable data1)
        {
            this.source2 = data;
            this.source1 = data1;
        }
        ...
        public void fnTransactionData()
        {
            ...
            try
            {
                command = new SqlCommand("spperformanceInvoice", connection, transaction);
